    ...
    return (
        <div className="flex h-full bg-[#1e1e1e] text-gray-200 font-sans">
            ...
            <div className="w-48 bg-[#252526] border-r border-white/10 p-4 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2 px-3 py-2 hover:bg-white/5 text-gray-400 rounded-lg text-sm font-medium cursor-not-allowed">
            ...
            <div className="flex-1 p-8 overflow-y-auto">
                ...
                <div className="space-y-8">
                    {/* Theme Section */}
                    <section>
                        <h3 className="text-sm font-medium text-gray-400 mb-4 uppercase tracking-wider">Theme</h3>
                    ...
                    {/* Language Section */}
                    <section>
                        <h3 className="text-sm font-medium text-gray-400 mb-4 uppercase tracking-wider">Language</h3>
