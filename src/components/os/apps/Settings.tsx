    ...
    return (
        <div className="flex h-full bg-white dark:bg-[#1e1e1e] text-gray-900 dark:text-gray-200 font-sans transition-colors duration-200">
            ...
            <div className="w-48 bg-gray-50 dark:bg-[#252526] border-r border-gray-200 dark:border-white/10 p-4 flex flex-col gap-2 transition-colors duration-200">
                ...
                <div className="flex items-center gap-2 px-3 py-2 hover:bg-black/5 dark:hover:bg-white/5 text-gray-600 dark:text-gray-400 rounded-lg text-sm font-medium cursor-pointer transition-colors">
            ...
            <div className="flex-1 p-8 overflow-y-auto">
                ...
                <div className="space-y-8">
                    ...
                    {/* Language Section */}
                    <section>
                        <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-4 uppercase tracking-wider">{t('settings.language')}</h3>
