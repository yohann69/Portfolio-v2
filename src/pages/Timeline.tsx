			...
			<div className="relative wrap overflow-hidden p-10 h-full">
				...
				<div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
					...
					<div className="order-1 w-5/12 px-1 py-4 text-right">
						...
						<p className="max-w-2xl text-base md:text-xl text-neutral-100 font-bold">Après
							l&apos;obtention
				...
				<div className="mb-8 flex justify-between items-center w-full right-timeline">
					...
					<div className="order-1  w-5/12 px-1 py-4">
						...
						<p className="max-w-2xl text-base md:text-xl text-neutral-100 font-bold">Ma première
				...
				<div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
					...
					<div className="order-1 w-5/12 px-1 py-4 text-right">
						...
						<p className="max-w-2xl text-base md:text-xl text-neutral-100 font-bold">En tant que
				...
				<div className="mb-8 flex justify-between items-center w-full right-timeline">
					...
					<div className="order-1  w-5/12 px-1 py-4">
						...
						<p className="max-w-2xl text-base md:text-xl text-neutral-100 font-bold">J&apos;ai
							récemment
				...
				<div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
					...
					<div className="order-1 w-5/12 px-1 py-4 text-right">
						...
						<h4 className="mb-3 font-bold text-lg md:text-2xl">Alternant développeur - La Poste</h4>
